...
const AngledCard: React.FC<{
    ...
    return (
        ...
        >
            {/* The Image Card */}
            <div className="relative h-full w-full overflow-hidden border border-white/10 bg-brand-dark/40
...
export const AngledSlider = ({
    ...
    return (
        <div
            className={cn(
                "relative w-full overflow-hidden bg-brand-dark py-10",
                className
            )}
            style={{
